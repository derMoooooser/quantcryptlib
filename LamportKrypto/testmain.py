...
gen = LamportGenerator("sha256")
gen.createKeyPair()
sig = gen.createSignatureForMessage(b"hey")
pubKey = gen.getPrivateKey()

verifier = LamportVerifier("sha256")
result = verifier.verify(b"he3y", sig, pubKey)
print(result)